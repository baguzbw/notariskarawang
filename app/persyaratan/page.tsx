    ...
    <>
      ...
      <main>
        ...
        <section className="bg-cream py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <p className="font-sans text-dongker/60 mb-12 max-w-2xl">
            ...
            <div className="space-y-8">
              {syaratData.map((item) => (
                ...
                >
                  <h2 className="font-serif text-xl font-semibold text-dongker mb-5">
                    {item.layanan}
                  </h2>
                  <ul className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {item.syarat.map((s) => (
                      <li key={s} className="flex items-start gap-3">
                        ...
                        <span className="font-sans text-sm text-dongker/70">{s}</span>
                      </li>
                    ))}
                  </ul>
                </div>
